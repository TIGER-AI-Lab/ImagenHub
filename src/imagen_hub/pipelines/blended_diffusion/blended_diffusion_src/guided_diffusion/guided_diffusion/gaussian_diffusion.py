...
class GaussianDiffusion:
    ...
    def p_sample_loop_progressive(
        ...
        # print what device the init_image is on
        print("init_image_batch.device", init_image_batch.device)
        print("th.tensor(indices[0], dtype=th.long, device=device)", th.tensor(indices[0], dtype=th.long, device=device))
        img = self.q_sample(
