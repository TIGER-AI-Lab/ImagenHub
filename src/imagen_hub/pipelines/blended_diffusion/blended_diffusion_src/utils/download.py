...
MODEL_PATHS = {
    ...
    "checkpoints/256_uncond": "https://openaipublic.blob.core.windows.net/diffusion/jul-2021/256x256_diffusion_uncond.pt",
    "checkpoints/512": "https://openaipublic.blob.core.windows.net/diffusion/jul-2021/512x512_diffusion.pt",
}


@lru_cache()
def default_cache_dir() -> str:
    return os.path.join(DIFFUSERS_CACHE, "blended_diffusion_cache")  # use diffuser path.
