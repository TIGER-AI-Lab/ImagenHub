...
def create_argparser():
    ...
    parser.add_argument(
        ...
        default="outputs/cdc_img2img-samples"
    )
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="/src/imagen_hub/pipelines/crossdomain_composition/crossdomain_composition_src/configs/stable-diffusion/v1-inpainting-inference.yaml",
        # default="/src/imagen_hub/pipelines/crossdomain_composition/crossdomain_composition_src/configs/stable-diffusion/v1-inference.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="/src/imagen_hub/pipelines/crossdomain_composition/crossdomain_composition_src/models/ldm/stable-diffusion-v1/sd-v1-4.ckpt",
