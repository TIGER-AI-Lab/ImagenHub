...
def load_json_list(file_paths: Union[str, list[str]], *, keys: tuple = None):
...
def load_json_list_parallel(file_paths: Union[str, list[str]], *, keys: tuple = None, max_workers=32):
