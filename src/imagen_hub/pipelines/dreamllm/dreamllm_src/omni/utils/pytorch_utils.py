...
is_torch_greater_or_equal_than_2_1 = is_torch_available(">=", "2.1")
is_torch_greater_or_equal_than_2_0 = is_torch_available(">=", "2.0")
is_torch_greater_or_equal_than_1_12 = is_torch_available(">=", "1.12")
is_torch_greater_or_equal_than_1_11 = is_torch_available(">=", "1.11")
is_torch_less_than_1_11 = is_torch_available("<", "1.11")
is_torch_1_8_0 = is_torch_available("==", "1.8.0")
