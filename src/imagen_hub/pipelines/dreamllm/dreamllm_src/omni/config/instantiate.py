...
from .registry import _convert_target_to_string, locate
...
def instantiate(cfg:  Union[list, ListConfig, abc.Mapping]):
    """
...
def deep_instantiate(cfg:  Union[list, ListConfig, abc.Mapping]):
    """
    Recursively instantiate objects defined in dictionaries by "_target_" and arguments.
