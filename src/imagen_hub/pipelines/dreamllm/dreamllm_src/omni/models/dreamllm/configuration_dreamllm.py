...
from .modeling_plugins import PluginType
...
ConfigAndInitKwargs = Dict[Union[_class_, _name_, _plugin_type_, InitKwargs], Any]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.special_tokens2ids_dict: Dict[
            SpecialToken,
            Union[SpecialTokenID, Dict[Union[SpecialToken, SpecialTokenID]]]
        ] = special_tokens2ids_dict

        self.plugins_init_kwargs = plugins_init_kwargs
