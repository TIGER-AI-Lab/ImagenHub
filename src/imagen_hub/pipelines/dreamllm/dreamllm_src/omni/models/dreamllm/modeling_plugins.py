...
from typing import Union, Optional, Callable, Dict, List, Literal, Any
from ..projector.builder import build_projector
from ...utils.fsdp_utils import FSDPMixin
from ...utils.import_utils import is_xformers_available
from ...utils.loguru import logger
from ...utils.misc import check_path_and_file
from ...utils.modeling_utils import get_model_device, get_model_dtype
from ...utils.torch_utils import is_compiled_module, randn_tensor
from typing import Union, List

PluginType = Literal["embedding", "head"]
PipelineImageType = Union[
    PIL.Image.Image,
    np.ndarray,
    torch.FloatTensor,
...
class MultimodalHead(PluginBase):
    initializer_range: float = 0.02
    plugin_type: Union[PluginType, str, None] = "head"
...
class StableDiffusionHead(MultimodalHead):
    def __init__(
        ...
        embed_hidden_size: int = 4096,
        drop_prob: Union[float, None] = None,
        noise_offset: float = 0.0,
        input_perturbation: float = 0.0,
        snr_gamma: Union[float, None] = None,
        resolution: int = 512,
    ...
    def forward(
        ...
        encoder_hidden_states: Union[torch.FloatTensor, None] = None,
        u_encoder_hidden_states: Union[torch.FloatTensor, None] = None,
        dream_embeddings: Union[torch.FloatTensor, None] = None,
    ):
    ...
    def pipeline(
        self,
        # prompt: Union[str, list[str]]| MultimodalContent = None,
        height= None,
        width = None,
        num_inference_steps= 50,
        guidance_scale = 7.5,
        # negative_prompt: Union[str, list[str]]| MultimodalContent | None = None,
...
class ControlNetHead(MultimodalHead):
    def __init__(
        self,
        controlnet_model_name_or_path: Union[str, list[str]]| tuple[str],
        diffusion_name_or_path: str,
        projector_type: str = "linear",
        projector_depth: int = 1,
        projector_name_or_path: str = None,
