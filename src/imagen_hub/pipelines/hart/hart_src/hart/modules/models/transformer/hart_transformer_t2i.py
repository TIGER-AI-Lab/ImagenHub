...
from ...diffusion.diffloss import DiffLoss
from ...models.autoencoder import (
    HARTAutoEncoder,
    HARTAutoEncoderWithDisc,
    HARTHybridQuantizer,
)
from .configuration import HARTForT2IConfig
from ...networks.basic_hart import (
    AdaLNBeforeHead,
    AdaLNSelfAttn,
    LlamaRMSNormFused,
    TimestepEmbedder,
...
class HARTForT2I(PreTrainedModel):
    ...
    def __init__(self, config: HARTForT2IConfig):
        ...
        self.rng = CopyableGenerator(device=device)
