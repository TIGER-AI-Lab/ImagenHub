...
from .step1xedit_src.sampling import get_schedule
from .step1xedit_src.modules.autoencoder import AutoEncoder
from .step1xedit_src.modules.conditioner import Qwen25VL_7b_Embedder as Qwen2VLEmbedder
from .step1xedit_src.modules.model_edit import Step1XParams, Step1XEdit
#from .step1xedit_src.modules.multigpu import parallel_transformer, teacache_transformer, parallel_teacache_transformer
...
def equip_dit_with_lora_sd_scripts(ae, text_encoders, dit, lora, device='cuda'):
    ...
    is_lora = True
    from .step1xedit_src.library import lora_module
    module = lora_module
